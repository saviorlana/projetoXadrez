    ...
    internal class PartidaDeXadrez {
        ...
        private Cor Adversaria(Cor cor) {
            if (cor == Cor.Branca) {
                ...
                return Cor.Branca; //nao precisa do else aqui, poderia ter colocado so return Cor.Branca;
            }
        }
        ...
        public bool EstaEmXeque(Cor cor) {
            Peca R = Rei(cor);
            if (R == null) { //esse if nao precisava, ja que este R nunca deverá ser null
